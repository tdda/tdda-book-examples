"""
test_make_test_2__1.py: Automatically generated test code from tdda gentest.

Generation command:

tdda gentest --non-zero-exit 'make test 2>&1' 'test_make_test_2__1.py' '.'
"""
...
class Test_MAKE_TEST_2(ReferenceTestCase):
    command = 'make test 2>&1'
    cwd = os.path.abspath(os.path.dirname(__file__))
    refdir = os.path.join(cwd, 'ref', 'make_test_2__1')
