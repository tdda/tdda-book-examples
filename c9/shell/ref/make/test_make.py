...
class Test_M(ReferenceTestCase):
    ...
    os.path.join(cwd, 'testalice1--verbose-output-tex.txt'),
    os.path.join(cwd, 'testalice1--verbose-output.txt'),
    os.path.join(cwd, 'testalice1-output-tex.txt'),
    os.path.join(cwd, 'testalice1-output.txt'),
    ...
    def test_testalice1__verbose_output_tex_txt(self):
        patterns = [
            r'^Ran 4 tests in 0\.[0-9]{3}[a-z]$',
        ]
        self.assertTextFileCorrect(os.path.join(self.cwd, 'testalice1--verbose-output-tex.txt'),
                                   os.path.join(self.refdir, 'testalice1--verbose-output-tex.txt'),
                                   encoding='ascii',
                                   ignore_patterns=patterns)

    def test_testalice1__verbose_output_txt(self):
        patterns = [
            r'^Ran 4 tests in 0\.[0-9]{3}[a-z]$',
        ]
        self.assertTextFileCorrect(os.path.join(self.cwd, 'testalice1--verbose-output.txt'),
                                   os.path.join(self.refdir, 'testalice1--verbose-output.txt'),
                                   encoding='ascii',
                                   ignore_patterns=patterns)


    def test_testalice1_output_tex_txt(self):
        patterns = [
            r'^Ran 4 tests in 0\.[0-9]{3}[a-z]$',
        ]
        self.assertTextFileCorrect(os.path.join(self.cwd, 'testalice1-output-tex.txt'),
                                   os.path.join(self.refdir, 'testalice1-output-tex.txt'),
                                   ignore_patterns=patterns,
                                   encoding='ascii')

    def test_testalice1_output_txt(self):
        patterns = [
            r'^Ran 4 tests in 0\.[0-9]{3}[a-z]$',
        ]
        self.assertTextFileCorrect(os.path.join(self.cwd, 'testalice1-output.txt'),
                                   os.path.join(self.refdir, 'testalice1-output.txt'),
                                   ignore_patterns=patterns,
                                   encoding='ascii')
