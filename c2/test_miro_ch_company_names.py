"""
test_miro_ch_company_names.py: Automatically generated test code from tdda gentest.

Generation command:

tdda gentest 'miro ch-company-names' 'test_miro_ch_company_names.py' '.'
"""
...
class Test_MIRO_CH_COMPANY_NA(ReferenceTestCase):
    command = 'miro ch-company-names'
    cwd = os.path.abspath(os.path.dirname(__file__))
    refdir = os.path.join(cwd, 'ref', 'miro_ch_company_names')
